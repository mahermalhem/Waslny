  ...
  return (
    <MainContainer Cstyle={{}}>
      ...
      <View style={{flexDirection: 'row', height: '100%'}}>
        <RoundButtonComp
          size={wp(35)}
          label={strings('signUp.driver')}
          onPress={()=>{navigation.navigate(SceneName.DriverSignUp)}}
        />
        <RoundButtonComp
          size={wp(35)}
          label={strings('signUp.customer')}
          onPress={()=>{navigation.navigate(SceneName.CustomerSignUp)}}
        />
      </View>
    </MainContainer>
  );
